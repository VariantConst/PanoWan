...
class LightningModelForTrain(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # Loss
        self.pipe.device = self.device
        print(f"latents.shape: {latents.shape}, generating noise...")
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Specify the modules to be finetuned in full finetune mode, e.g., 'q,k,v,o'. If not specified, all parameters will be finetuned.",
    )
    parser.add_argument(
        "--use_swanlab",
        default=False,
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Finetune decoder(head) part. Only effective in full finetune mode.",
    )
    parser.add_argument(
        "--resume_path",
        type=str,
        default=None,
        help="Path of the checkpoint to resume training.",
    )
